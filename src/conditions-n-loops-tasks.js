...
function convertToRomanNumerals(num) {
  ...
  const units = num % 10;
  let acc = romanNumerals[5];

  for (let i = dozens; i !== 0; ) {
  ...
  switch (units) {
    ...
    case 4:
    case 5:
      result += ((units < 5 && romanNumerals[1]) || '') + romanNumerals[5];
      break;
    case 6:
    case 7:
    case 8:
      for (let i = units - 5; i !== 0; ) {
        acc += romanNumerals[1];
        i -= 1;
      }
      result += acc;
    ...
    case 9:
    case 10:
      result += ((units < 10 && romanNumerals[1]) || '') + romanNumerals[10];
      break;
    default:
      return result;
  }
